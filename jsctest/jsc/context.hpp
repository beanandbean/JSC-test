...
struct context_group {
    ...
    inline ~context_group() {
        JSContextGroupRelease(_ref);
    }
...
struct context {
    ...
    inline context() : _ref{JSGlobalContextCreate(nullptr)}, _exception{undefined()} {}
    inline context(const context_group& group) : _ref{JSGlobalContextCreateInGroup(group._ref, nullptr)}, _exception{undefined()} {}
    ...
    inline value val(jsc::tag_null) {
        return {*this, JSValueMakeNull(_ref)};
    }
    inline value val(bool b) {
        return {*this, JSValueMakeBoolean(_ref, b)};
    }
    inline value val(int i) {
        return val(static_cast<double>(i));
    }
    inline value val(double num) {
    ...
    inline value val(object obj) {
        return obj;
    }
    
    inline value undefined() {
        return val(jsc::undefined);
    }
    inline value null() {
        return val(jsc::null);
    }
...
private:
    using internal_callback_type = std::function<JSValueRef(JSContextRef, JSObjectRef, JSObjectRef, size_t, const JSValueRef[], JSValueRef*)>;
    
    static JSValueRef callback_class_call(JSContextRef ctx, JSObjectRef function, JSObjectRef this_object, size_t argument_count, const JSValueRef arguments[], JSValueRef* exception);
...
public:
    ...
    inline object callable(callback_type callback) {
        const auto callback_func = [&callback](JSContextRef ctx, JSObjectRef function, JSObjectRef this_object, size_t argument_count, const JSValueRef arguments[], JSValueRef* exception) {
            ...
            if constexpr (std::is_same_v<decltype(callback(global_context, this_obj, vector, &exception_placeholder)), void>) {
                callback(global_context, this_obj, vector, &exception_placeholder);
            } else if constexpr (std::is_same_v<decltype(callback(global_context, this_obj, vector, &exception_placeholder)), value>) {
                result = callback(global_context, this_obj, vector, &exception_placeholder);
            } else {
                result = global_context.val(callback(global_context, this_obj, vector, &exception_placeholder));
            }
        ...
        return {*this, JSObjectMake(_ref, callback_class(), new internal_callback_type{callback_func})};
    }
    
    inline bool ok() const {
        return _exception.is_undefined();
    }
    inline const value& get_exception() const {
        return _exception;
    }
