...
struct property {
    inline property(const object& obj, property_type prop) : _obj{obj}, _prop{prop} {}
    
    inline property(const property<property_type>& prop) : _obj{prop._obj}, _prop{prop._prop} {}
    ...
    inline bool exists() const {
        return _obj.has_property(_prop);
    }
    
    inline bool remove() const {
        return _obj.remove_property(_prop);
    }
    
    inline value get() const {
        return _obj.get_property(_prop);
    }
    ...
    template <typename val_type,
        typename = std::enable_if_t<!std::is_same_v<val_type, property<property_type>>>>
